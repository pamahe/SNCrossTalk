...
int main(int argc_, char** argv_) 
{
  ...
  try {
    ...
    TH1D *histo_full = new TH1D("full","Hit time distribution for all OM, full run", 100000, 30, 58);
	...
	TH1D *histo = new TH1D(histo_name.c_str(), histo_title.c_str(), 10000, 0.0, 4000.0);
